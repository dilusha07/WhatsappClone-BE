package com.MDS.Whatsapp_clone.infrastructure.secondary.entity;

import com.MDS.Whatsapp_clone.messaging.domain.user.aggregate.Authority;
import com.MDS.Whatsapp_clone.messaging.domain.user.aggregate.AuthorityBuilder;
